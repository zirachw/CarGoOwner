...
class Pelanggan:
    ...
    Handles querying and modifying customer data in the database.
    """
    NIK: str
    Nama: str
    Kontak: str
    ...
    def __init__(self):
        """Initialize database path based on schema location.
        
        Args:
            schema_path (str): Path to the schema file, used to determine database location
        """
